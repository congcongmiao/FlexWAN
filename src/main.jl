...
function main()
    ...
    if abstractoptical > 0
        ...
        IPTopo, OpticalTopo, IPScenarios, OpticalScenarios = get_failure_scenarios(dir, AllTopologies[1], AllTopoIndex[1], verbose, scenario_cutoff, scenario_id, weibull_or_k, failure_free, expanded_spectrum, 4)
