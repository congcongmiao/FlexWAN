...
exp_topo="Cernet"  # experiment topology, B4 ,Custom_2, Cernet Case_8
...
if [ $exp_topo = "B4" ]
then
    option_num_set=3 #80  # a single large ticket file, then read partially
    ...
    cutoff_value=0.005  # probabilistic scenario cutoff
    topo_index="1"
    scenario_set=$(seq 1 1 1)
elif [ $exp_topo = "IBM" ]
then
